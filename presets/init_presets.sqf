...
switch (KP_liberation_preset_blufor) do {
    ...
    case 31: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\Marine_WDL.sqf";};
...
switch (KP_liberation_preset_opfor) do {
    ...
    case 21: {[] call compileFinal preprocessFileLineNumbers "presets\opfor\Russia_Woodland.sqf";};
...
switch (KP_liberation_preset_civilians) do {
    ...
    case  8: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\Western_European.sqf";};
